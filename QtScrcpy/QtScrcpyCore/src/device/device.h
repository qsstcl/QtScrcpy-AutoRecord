...
public:
    ...
    DeviceParams& getDeviceParams() override;
    ...
    void screenshotWithFilename(const QString& filename) override;
...
private:
    ...
    bool saveFrameWithFilename(int width, int height, uint8_t* dataRGB32, const QString& path);
